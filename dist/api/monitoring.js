...
class MonitoringService {
    ...
    trackRequest(method, endpoint, statusCode, responseTime) {
        ...
        this.requestMetrics.byEndpoint.set(endpoint, (this.requestMetrics.byEndpoint.get(endpoint) || 0) + 1);
        this.requestMetrics.byMethod.set(method, (this.requestMetrics.byMethod.get(method) || 0) + 1);
