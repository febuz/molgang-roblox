...
exports.setupGitHubRoutes = setupGitHubRoutes;
const logger_1 = __importDefault(require("../utils/logger"));
function setupGitHubRoutes(app, githubSync, authMiddleware) {
    app.get('/api/github/sync/status', authMiddleware.verifyToken(), (_req, res) => {
        try {
    ...
    app.get('/api/github/sync/history', authMiddleware.verifyToken(), (req, res) => {
        try {
    ...
    app.get('/api/github/sync/stats', authMiddleware.verifyToken(), (_req, res) => {
        try {
    ...
    app.post('/api/github/sync', authMiddleware.requireRole('ceo'), async (_req, res) => {
        try {
    ...
    app.post('/api/github/sync/configure', authMiddleware.requireRole('ceo'), (_req, res) => {
        try {
    ...
    logger_1.default.info('✓ GitHub sync routes configured');
}
exports.default = setupGitHubRoutes;
