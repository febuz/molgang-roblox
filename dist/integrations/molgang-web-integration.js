...
exports.molGangIntegration = exports.MOLGANGWebIntegration = void 0;
const logger_1 = __importDefault(require("../utils/logger"));
class MOLGANGWebIntegration {
    constructor() {
    ...
    registerEndpoints(app) {
        ...
        logger_1.default.info('✅ MOLGANG Web Integration endpoints registered (12 routes)');
    }
    ...
    handleRegister(req, res) {
        ...
        logger_1.default.info(`📚 New player registered: ${username}`);
        res.json({
            success: true,
            playerId,
    ...
    handleGetSessionStatus(req, res) {
    ...
    // ========== EDUCATIONAL TRACKING ==========
    handleGetEducationalProgress(req, res) {
        const { playerId } = req.params;
        res.json({
            success: true,
            progress: {
    ...
    // ========== MULTIPLAYER SYNCHRONIZATION ==========
    handleBroadcastEvent(req, res) {
        const { eventType, data } = req.body;
        logger_1.default.info(`📡 Broadcasting event: ${eventType}`);
        res.json({
            success: true,
    ...
    handleGetNearbyPlayers(req, res) {
...
exports.MOLGANGWebIntegration = MOLGANGWebIntegration;
exports.molGangIntegration = new MOLGANGWebIntegration();
//# sourceMappingURL=molgang-web-integration.js.map