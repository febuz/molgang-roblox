...
local data = {
	dailyStats = {date = "2000-01-01", atomsCollected = 99, moleculesBuilt = 99, molCoinsEarned = 99},
...
assert(stats.atomsCollected == 0 and stats.moleculesBuilt == 0 and stats.molCoinsEarned == 0,
