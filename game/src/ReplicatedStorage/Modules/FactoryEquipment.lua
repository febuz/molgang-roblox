...
FactoryEquipment.Items = {
	...
	},
	{
		...
		powerKW = 15,
		productionType = "pump",
		description = "Moves liquids between tanks. Required to connect leaching tanks to filtration press.",
		color = Color3.fromRGB(120, 140, 160),
		adjacencyBonus = {leaching_tank = 1.10, filtration_press = 1.10},
		tier = 2,
	},
	{
		id = "gate_valve",
		...
		monthlyCost = 20,
		powerKW = 0,
		productionType = "flow_control",
		description = "Controls flow between equipment. Place between tanks and pumps for process control.",
	...
	},
	{
		...
		monthlyCost = 50,
		powerKW = 2,
		productionType = "lab_workspace",
		description = "Full lab bench with sink, gas burner, flask rack. Required for bench-scale testing.",
		color = Color3.fromRGB(130, 110, 80),
		adjacencyBonus = {ph_meter_station = 1.15, xrf_analyzer = 1.10},
		tier = 1,
	},
	{
		id = "spray_dryer",
		...
		monthlyCost = 600,
		powerKW = 80,
		productionType = "dry_spray",
		productionRate = 12,
		description = "Converts liquid solutions into dry powder instantly. Essential for V2O5 product finishing.",
		color = Color3.fromRGB(160, 165, 175),
		adjacencyBonus = {precipitation_tank = 1.20, storage_silo = 1.15},
		tier = 4,
	},
	{
		id = "screw_conveyor",
		name = "Screw Conveyor (12m)",
		category = "Storage",
		model = "screw_conveyor",
		gridSize = {6, 1},
		cost = 3500,
		monthlyCost = 80,
		powerKW = 4,
		productionType = "transport_enclosed",
		description = "Enclosed powder/granule transport. Better than belt conveyor for fine materials and dust control.",
		color = Color3.fromRGB(140, 140, 150),
		linkBonus = 1.12,
		tier = 2,
	},
	{
		id = "thickener_tank",
		name = "Thickener/Clarifier Tank",
		category = "Separation",
		model = "thickener_tank",
		gridSize = {5, 5},
		cost = 20000,
		monthlyCost = 400,
		powerKW = 15,
		productionType = "thicken",
		productionRate = 30,
		description = "Gravity settling of suspended solids. Concentrates slurry before filtration. Large but efficient.",
		color = Color3.fromRGB(150, 145, 135),
		adjacencyBonus = {filtration_press = 1.20, centrifuge = 1.15},
		tier = 3,
	},
	{
		id = "beaker_set",
